      ...
      if (!island && !region) return true;
        if (!text) return false;
          const lower = text.toLowerCase();
            if (region) {
                    return REGION_KEYWORDS[region]?.some((kw) => lower.includes(kw)) ?? false;
            }
              return (
                    ISLAND_REGIONS[island!]?.some((r) =>
                          REGION_KEYWORDS[r]?.some((kw) => lower.includes(kw))
                    ) ?? false
              );
}
                                                        ...
                                                        <div className="flex flex-wrap items-center gap-2">
                                                                  {["North Island", "South Island"].map((i) => (
                                                                                <button
                                                                                              key={i}
                                                                                                            type="button"
                                                                                                                          onClick={() => selectIsland(i)}
                                                                                                                                        aria-pressed={island === i}
                                                                                                                                        className={cn(
                                                                                                                                                            "rounded-full border px-4 py-1.5 text-sm font-medium transition-colors",
                                                                                                                                                                            island === i
                                                                                                                                                                                              ? "border-ink bg-ink text-white"
                                                                                                                                                                                                                : "border-line bg-white text-zinc-700 hover:border-zinc-400"
                                                                                                                                        )}
                                                                                                                                                    >
                                                                                                                                                                  {i}
                                                                                                                                                                              </button>
                                                                            ...
                                                                            {isFiltered && (
                                                                                            <button
                                                                                                          type="button"
                                                                                                                        onClick={clear}
                                                                                                                                      className="px-2 text-sm text-zinc-400 hover:text-zinc-600"
                                                                                                                                                  >
                                                                                                                                                                Clear x
                                                                                                                                                                            </button>
                                                                            )}
                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                          "rounded-full border px-3 py-1 text-xs font-medium transition-colors",
                                                                                                                                                                                                                                            region === r
                                                                                                                                                                                                                                                                ? "border-turf-600 bg-turf-600 text-white"
                                                                                                                                                                                                                                                                                    : "border-line bg-white text-zinc-600 hover:border-turf-400"
                                                                                                                                                                                                      )}
                                                                                                                                                                                                                    >
                                                                                                                                                                                                                                    {r}
                                                                                                                                                                                                                                                  </button>
                                                                                                              ...
                                                                                                              {filteredTrainers.length > 0 ? (
                                                                                                                        ...
                                                                                                                        <div className="rounded-2xl border border-dashed border-line bg-white px-6 py-10 text-center">
                                                                                                                                  <p className="text-sm text-zinc-500">
                                                                                                                                              {isFiltered
                                                                                                                                                            ? "No verified trainers in this region."
                                                                                                                                                                          : "No verified trainers yet."}
                                                                                                                                                                                    </p>
                                                                                                                                                                                            </div>
                              )}
                              
                                    {/* NZTR registry section */}
                                                                                                                                    ...
                                                                                                                                    <h2 className="font-display text-xl font-semibold tracking-tight text-ink">
                                                                                                                                                    Not on JockeyFinder yet
                                                                                                                                                                                ...
                                                                                                                                                                                <p className="mt-1 max-w-2xl text-sm text-zinc-500">
                                                                                                                                                                                                Licensed trainers listed on the public NZTR register. Tap a name to see
                                                                                                                                                                                                                their contact info. They unlock their full profile the moment
                                                                                                                                                                                                                                they sign up.
                                                                                                                                                                                                                                              </p>
                                                                                                                                                                                                                                                          </div>
                                                                                                                                                                                                                                                                      <Link href="/signup?role=trainer" className={buttonClasses("outline", "sm")}>
                                                                                                                                                                                                                                                                                    I am a trainer, sign me up
                                                                                                                                                                                                                                                                                                </Link>
                                                                                                                                                                                                                                                                                                          </div>
                                                                                                                                                                                                                                                                                                                    {filteredRegistry.length > 0 ? (
                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                    <div className="rounded-2xl border border-dashed border-line bg-white px-6 py-6 text-center">
                                                                                                                                                                                                                                                                                                                                                  <p className="text-sm text-zinc-500">
                                                                                                                                                                                                                                                                                                                                                                  No registry entries for this region.
                                                                                                                                                                                                                                                                                                                                                                                </p>
                                                                                                                                                                                                                                                                                                                                                                                            </div>
                                                                                                                                                                                                                                                                                                                    )}
                                                                                                                                                                                                                                                                                                                            </section>
